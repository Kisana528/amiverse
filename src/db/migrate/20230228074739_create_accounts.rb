class CreateAccounts < ActiveRecord::Migration[7.0]
  def change
    create_table :accounts do |t|
      t.string :account_id, null: false, index: true, unique: true
      t.string :name, null: false, default: ''
      t.string :name_id, null: false, index: true, unique: true
      ...
      t.string :email, index: true, unique: true, null: false, default: ''
